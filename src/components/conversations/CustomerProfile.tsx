...
export const CustomerProfile = ({ customer, onClose }: CustomerProfileProps) => {
  ...
  return (
    <div className="w-full h-full border-l border-border/50 bg-background flex flex-col">
      <div className="p-3 sm:p-4 border-b border-border/50 bg-muted/30 flex items-center justify-between flex-shrink-0">
